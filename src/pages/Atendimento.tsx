...
function waToConversa(wa: WaConversation, profileMap: Map<string, string>): Conversa {
  ...
  return {
    ...
    nome: wa.wa_name,
    waName: wa.wa_name,
    telefone: (wa.wa_phone?.includes("@lid") || wa.wa_phone?.startsWith("lid:") || wa.wa_jid?.includes("@lid")) ? (wa.wa_phone || wa.wa_jid || "") : (wa.wa_phone?.startsWith("+") ? wa.wa_phone : `+${wa.wa_phone}`),
