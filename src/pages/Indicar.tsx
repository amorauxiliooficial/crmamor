      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4 py-8">
        <div className="w-full max-w-md text-center space-y-8 animate-fade-in">
          ...
          <div className="relative">
            <div className="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-primary/20 to-primary/10 flex items-center justify-center animate-scale-in">
            ...
            <Heart className="absolute -top-2 -right-4 h-6 w-6 text-primary/40 animate-pulse" />
            <Heart className="absolute top-8 -left-6 h-4 w-4 text-primary/30 animate-pulse" style={{ animationDelay: '0.5s' }} />
          </div>
          ...
          <div className="bg-gradient-to-r from-primary/5 to-primary/10 rounded-2xl p-6 space-y-4 border border-primary/10">
            <div className="flex items-center justify-center gap-2">
              <Gift className="h-5 w-5 text-primary" />
              <span className="font-semibold text-foreground">Suas Recompensas</span>
            </div>
            <div className="flex justify-center gap-4 text-center">
              <div className="bg-background rounded-xl px-4 py-3 shadow-sm">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 w-full bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-medium py-3 px-4 rounded-xl hover:opacity-90 transition-opacity"
            >
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 flex flex-col items-center px-4 py-6">
        <div className="w-full max-w-md space-y-6 animate-fade-in">
          ...
          <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 rounded-2xl p-5 border border-primary/10">
            <div className="flex items-center justify-center gap-2 mb-4">
              <Gift className="h-5 w-5 text-primary" />
              <span className="font-semibold text-foreground">Ganhe até R$200!</span>
            </div>
            <div className="flex justify-center gap-4">
              <div className="flex-1 bg-background rounded-xl p-4 text-center shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="bg-background rounded-2xl border shadow-sm p-6 space-y-6">
