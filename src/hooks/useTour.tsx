...
export const tourSteps: TourStep[] = [
  ...
  },
  {
    target: ".tour-kanban",
    title: "Quadro Kanban 📋",
    content: "Arraste os cards entre colunas para atualizar o status. Cada coluna representa uma etapa do processo: Entrada, Análise, Pendência, Elegível, Protocolo, Aguardando INSS, etc.",
    placement: "top",
  },
  {
    target: ".tour-view-table",
    title: "Visualização em Tabela 📑",
    content: "Clique em 'Tabela' para ver todos os processos em formato de lista com mais detalhes visíveis de uma vez.",
    placement: "bottom",
  },
  {
    target: ".tour-view-gestantes",
    title: "Acompanhamento de Gestantes 🤰",
    content: "Clique em 'Gestantes' para ver o quadro específico de gestantes organizado por mês de gestação. Ideal para acompanhar DPPs.",
    placement: "bottom",
  },
  {
    target: ".tour-view-conferencia",
    title: "Conferência INSS ✅",
    content: "Clique em 'Conferência INSS' para registrar verificações diárias no portal do INSS. Acompanhe se houve atualizações nos processos.",
    placement: "bottom",
  },
  {
    target: ".tour-view-pagamentos",
    title: "Controle de Pagamentos 💰",
    content: "Clique em 'Pagamentos' para gerenciar honorários. Cadastre valores, parcelas e acompanhe o status de cada pagamento.",
    placement: "bottom",
  },
  {
    target: ".tour-view-indicacoes",
    title: "Gestão de Indicações 👥",
    content: "Clique em 'Indicações' para gerenciar leads. Registre indicadoras, agende follow-ups e acompanhe o status de cada abordagem.",
    placement: "bottom",
  },
  {
