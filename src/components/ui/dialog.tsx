  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        fullscreenOnMobile && "inset-0 w-full h-full max-h-screen overflow-y-auto p-4",
        // Desktop: centered modal
        fullscreenOnMobile && "md:inset-auto md:left-[50%] md:top-[50%] md:h-auto md:max-h-[90vh] md:w-full md:max-w-lg md:translate-x-[-50%] md:translate-y-[-50%] md:rounded-lg md:p-6",
        !fullscreenOnMobile && "left-[50%] top-[50%] w-full max-w-lg translate-x-[-50%] translate-y-[-50%] p-6 sm:rounded-lg",
